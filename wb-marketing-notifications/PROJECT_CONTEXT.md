...
Для этого подпроекта нужно различать тестовый и продовый чаты.

- Тестовый чат: `39363429`.
- Продовый чат: `36815841`.

Продовый чат `36815841` - это тот же чат, который сейчас настроен для действующих FBO-уведомлений.
...
3. После подтверждения формата и логики можно переключать новый подпроект на продовый чат `36815841`.
